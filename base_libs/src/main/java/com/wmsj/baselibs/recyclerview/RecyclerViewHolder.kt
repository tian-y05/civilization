...
class RecyclerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun setHintText(viewId: Int, text: CharSequence): RecyclerViewHolder {
        val view = getView<TextView>(viewId)
        view.hint = "" + text
        return this
    }
     ...
     * @return
     */
    fun setImagePath(viewId: Int, imageLoader: HolderImageLoader): RecyclerViewHolder {
        val iv = getView<ImageView>(viewId)
     ...
     * 设置View的Visibility
     */
    fun setViewVisibility(viewId: Int, visibility: Int): RecyclerViewHolder {
