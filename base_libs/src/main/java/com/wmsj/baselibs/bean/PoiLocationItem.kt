...
data class PoiLocationItem(
    ...
    companion object CREATOR : Parcelable.Creator<PoiLocationItem> {
        override fun createFromParcel(parcel: Parcel): PoiLocationItem {
            return PoiLocationItem(parcel)
        }

        override fun newArray(size: Int): Array<PoiLocationItem?> {
